defmodule TreechatWeb.Router do
  ...
  pipeline :browser do
    ...
    plug :put_root_layout, html: {TreechatWeb.Layouts, :root}
  ...
  if Application.compile_env(:treechat, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: TreechatWeb.Telemetry
  ...
  scope "/", TreechatWeb do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{TreechatWeb.UserAuth, :redirect_if_user_is_authenticated}] do
  ...
  scope "/", TreechatWeb do
    ...
    live_session :current_user,
      on_mount: [{TreechatWeb.UserAuth, :mount_current_user}] do
